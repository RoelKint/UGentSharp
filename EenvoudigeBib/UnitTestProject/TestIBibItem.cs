...
namespace UnitTestProject
{
    ...
    public class TestIBibItem
    {
        ...
        public void TestVoegToe()
        {
            ...
            // tijdschrift
            IBibItem tijdschrift = new TijdSchrift { Id = "ID03", Naam = "Scientific American", Datum = new DateTime(2014, 8, 1), Uitgeverij = "Scientific American" };
            IBibItem artikel = new Artikel { Id = "ID04", Naam = "Planets we could call home", Auteur = "Dimitar Sasselov" };
            tijdschrift.VoegToe(artikel);
            IBibItem artikel2 = new Artikel { Id = "ID05", Naam = "Robot Pills", Auteur = "Paolo Dario" };
        ...
        public void TestZoekId()
        {
            ...
            // artikel
            IBibItem artikel = new Artikel { Id = "ID02", Naam = "Ik ben Pelgrim", Auteur = "Terry Hayes" };
            Assert.AreEqual(artikel, artikel.Zoek("ID02"));
            Assert.AreEqual(null, artikel.Zoek("ID03"));
            // tijdschrift
            IBibItem tijdschrift = new TijdSchrift { Id = "ID03", Naam = "Scientific American", Datum = new DateTime(2014, 8, 1), Uitgeverij = "Scientific American" };
            artikel = new Artikel { Id = "ID04", Naam = "Planets we could call home", Auteur = "Dimitar Sasselov" };
            tijdschrift.VoegToe(artikel);
            IBibItem artikel2 = new Artikel { Id = "ID05", Naam = "Robot Pills", Auteur = "Paolo Dario" };
            tijdschrift.VoegToe(artikel2);
        ...
        {
            // boek
            IBibItem item = new Boek { Id = "ID01", Auteur = "Hertmans", Naam = "In de herfst" };
            ...
            // artikel
            item = new Artikel { Id = "ID02", Auteur = "Hertmans", Naam = "In de herfst" };
            Assert.IsTrue(item.ZoekTrefwoord("herfst").Contains(item));
            Assert.IsTrue(item.ZoekTrefwoord("ert").Contains(item));
            Assert.IsTrue(item.ZoekTrefwoord("s").Contains(item));
            // tijdschrift
            item = new TijdSchrift { Id = "ID03", Naam = "Scientific American", Datum = new DateTime(2014, 8, 1), Uitgeverij = "Scientific American" };
            IBibItem artikel = new Artikel { Id = "ID04", Naam = "Planets we could call home", Auteur = "Dimitar Sasselov" };
            ...
            // tijdschrift
            IBibItem tijdschrift = new TijdSchrift { Id = "ID01", Naam = "Scientific American", Datum = new DateTime(2014, 8, 1), Uitgeverij = "Scientific American" };
            artikel = new Artikel { Id = "ID02", Naam = "Planets we could call home", Auteur = "Dimitar Sasselov" };
            tijdschrift.VoegToe(artikel);
            artikel = new Artikel { Id = "ID03", Naam = "Robot Pills", Auteur = "Paolo Dario" };
            tijdschrift.VoegToe(artikel);
            afdeling.VoegToe(tijdschrift);
            // boek
            IBibItem boek = new Boek { Id = "ID04", Naam = "Ik ben Pelgrim", Auteur = "Terry Hayes", Uitgeverij = "Bruna", Jaartal = 2014 };
            afdeling.VoegToe(boek);
            // boek
        ...
        public void TestVerplaatsNaar()
        {
            // boek verplaatsen
            IBibItem afdeling = new Afdeling { Id = "WET", Naam = "Wetenschappen" };
            IBibItem boek = new Boek { Id = "ID01", Auteur = "Hertmans", Naam = "In de herfst" };
            afdeling.VoegToe(boek);
            IBibItem artikel = new Artikel { Id = "ID02", Auteur = "Hertmans", Naam = "In de herfst" };
            ...
            afdeling.VoegToe(tijdschrift);
            // boek
            boek = new Boek { Id = "ID04", Naam = "Ik ben Pelgrim", Auteur = "Terry Hayes", Uitgeverij = "Bruna", Jaartal = 2014 };
            afdeling.VoegToe(boek);
            // boek
            boek = new Boek { Id = "ID05", Naam = "Kou uit het oosten", Auteur = "Ken Follett", Uitgeverij = "Van Holkema", Jaartal = 2014 };
            afdeling.VoegToe(boek);
            ...
            afdeling2.VoegToe(boek);
            // boek
            IBibItem boek2 = new Boek { Id = "ID10", Naam = "De monogrammoorden", Auteur = "Ken Follett", Uitgeverij = "Van Holkema", Jaartal = 2014 };
